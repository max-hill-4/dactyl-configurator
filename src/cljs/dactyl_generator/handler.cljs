...
(defn api-generate-manuform [body]
  (let [keys           (get body "keys")
        ...
        c              {:configuration-ncols                       (get keys "columns" 5)
                        ...
                        :configuration-custom-thumb-cluster?       (get shaping "customThumbCluster" false)
                        ...
                        :configuration-thumb-bottom-left-tenting-x (get-angle shaping "thumbBottomLeftTentingX" (/ Math/PI 10))
                        :configuration-thumb-bottom-left-tenting-y (get-angle shaping "thumbBottomLeftTentingY" (/ Math/PI -4))
                        :configuration-thumb-bottom-left-tenting-z (get-angle shaping "thumbBottomLeftTentingZ" (/ Math/PI 10))
                        :configuration-thumb-bottom-left-offset-x  (get shaping "thumbBottomLeftOffsetX" -35)
                        :configuration-thumb-bottom-left-offset-y  (get shaping "thumbBottomLeftOffsetY" -16)
                        :configuration-thumb-bottom-left-offset-z  (get shaping "thumbBottomLeftOffsetZ" 2)
                        :configuration-thumb-bottom-right-tenting-x (get-angle shaping "thumbBottomRightTentingX" (/ Math/PI 10))
                        :configuration-thumb-bottom-right-tenting-y (get-angle shaping "thumbBottomRightTentingY" (/ Math/PI -4))
                        :configuration-thumb-bottom-right-tenting-z (get-angle shaping "thumbBottomRightTentingZ" (/ Math/PI 10))
